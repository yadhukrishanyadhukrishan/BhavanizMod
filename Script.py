class script(object):
    START_TXT = """𝑴𝒀 𝑵𝑨𝑴𝑬 , <a href='https://t.me/IT_BUT_BOT'>🇮 🇹 _അണ്ണൻ</a>, 𝑰𝒕'𝒔 𝑽𝒆𝒓𝒓𝒚 𝑬𝒂𝒔𝒚. 𝑱𝒖𝒂𝒕 𝑨𝒅𝒅 𝑴𝒆 𝑻𝒐 𝒀𝒐𝒖𝒓 𝑮𝒓𝒐𝒖𝒑 𝑨𝒏𝒅 𝑴𝒂𝒌𝒆 𝑴𝒆 𝑨𝒅𝒎𝒊𝒏, 𝑻𝒉𝒂𝒕𝒔 𝑨𝒍𝒍, 𝑰'𝑳𝑳 𝑷𝒓𝒐𝒗𝒊𝒅𝒆 𝑴𝑶𝑽𝑰𝑬𝑺 𝑻𝒉𝒆𝒓𝒆 🤓
𝑯𝑬𝒀,<a href='http://t.me/IT_BUT_BOT?startgroup=true'>𝑨𝒅𝒅 𝑴𝒆 𝑻𝒐 𝒀𝒐𝒖𝒓 𝑮𝒓𝒐𝒖𝒑 𝑨𝒏𝒅 𝑴𝒂𝒌𝒆 𝑴𝒆 𝑨𝒏 𝑨𝒅𝒎𝒊𝒏 𝑻𝒉𝒆𝒓𝒆</a>
➖➖➖➖➖➖➖➖➖➖➖𝙽𝙸𝙽𝙶𝙰𝙻𝙺 𝚅𝙴𝙽𝙳𝙰 𝙼𝙾𝚅𝙸𝙴𝚂 𝙸𝚅𝙸𝙳𝙴 𝙺𝙸𝚃𝚃𝚄𝙼 𝙴𝙽𝙽𝙰𝚃𝙷𝙰𝙽𝚄
